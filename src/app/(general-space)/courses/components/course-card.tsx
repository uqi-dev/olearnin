import JSIcon from "@/svgIcons/js";
import AngularIcon from "@/svgIcons/angular";
import { ChevronsRight } from "lucide-react";
import GoIcon from "@/svgIcons/go";

const CourseCard = () => {
  return <div className="course-card shadow rounded-xl overflow-hidden w-[270px]">
    <div className="flex justify-center items-center card-top bg-secondary relative overflow-hidden h-[225px] w-[270px]">
      ...
      <div className="bg-[#00000017] px-3 h-full relative backdrop-blur-sm">
        {/*  language logo */}
        <div className="min-w-[120px] flex gap-0.5 mb-1 ">
          <JSIcon className="w-10 bg-[#00000029]"/>
          {/*<AngularIcon className="w-10 bg-[#00000029]"/>*/}
          <GoIcon className="w-10 bg-[#00000029]"/>
